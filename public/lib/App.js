...
export class App extends React.Component {
  render() {
    ...
    const obj = messages[this.randomNumber()].values.split(delimeter); // Code Example
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Headline, {
      showbackground: "true",
      color: "white",
      fontsize: "48px",
      centered: "true",
